...
(function() {
  var each, eachSeries, getError, isArray, isFunction, nextTick, parallel, series, slice, thenjs;
  ...
  thenjs = function(startFn, context) {
    var Promise, createHandler, eachAndSeriesFactory, fail, parallelAndSeriesFactory, promiseFactory, tryNextTick;
    fail = [];
