...
m;c+=1;c<e&&p(h)?k(a[c])?a[c].call(d,f,c):b(l(a[c],"series","function")):(delete g[-1],b(h||null,g))}var e,c=-1,g=[];f._next_then={};q(a)?(e=a.length)?f():b(null,g):b(l(a,"series","array"))}function s(b,a){D(function(){try{a()}catch(d){b(d)}})}function r(b,a){return k(a)?a._next_then?a:a.bind(null,b):null}function t(b){function a(a,b){var c=new e,d=c.defer.bind(c);d._next_then=c;a(d,b);return c}var d=[],f=0,e=function(){},c=e.prototype;c.debug=b;c.all=function(c){return a(function(a,b){b._all=r(a,
c)},this)};c.then=function(c,b){return a(function(a,d){d._success=r(a,c);d._error=r(a,b)},this)};c.fail=function(c){return a(function(a,b){b._fail=r(a,c);b._success=a.bind(a,null);b._fail&&d.push(b._fail)},this)};c.each=function(b,c,d){return a(function(a,e){e._each=function(e,f,k){w(a,b||e,c||f,d||k)}},this)};c.eachSeries=function(b,c,d){return a(function(a,e){e._eachSeries=function(e,f,k){x(a,b||e,c||f,d||k)}},this)};c.parallel=function(b,c){return a(function(a,d){d._parallel=function(d,e){y(a,
b||d,c||e)}},this)};c.series=function(b,c){return a(function(a,d){d._series=function(d,e){z(a,b||d,c||e)}},this)};c.defer=function(a){f+=1;this._error=this._fail?d.shift():this._error;this._success=this._success||this._each||this._eachSeries||this._parallel||this._series||v;try{if(this.debug){var b=u.call(arguments);b.unshift("Then chain "+f+":");k(this.debug)?this.debug.apply(this.debug,b):"object"===typeof console&&k(console.log)&&console.log.apply(console,b)}if(this._all)this._all.apply(this._all._next_then,
u.call(arguments));else if(p(a))this._success.apply(this._success._next_then,u.call(arguments,1));else throw a;}catch(c){if(this._error||d.length)(this._error?this._error:d.shift())(c);else throw c;}finally{this._all=v}};return a}function A(b){return function(a,d,f,e){return t(e)(function(c){s(c,b.bind(null,c,a,d,f))})}}function B(b){return function(a,d,f){return t(f)(function(e){s(e,b.bind(null,e,a,d))})}}function n(b,a,d){return t(d)(function(d){s(d,k(b)?b.bind(a,d):d)})}var u=[].slice,q=Array.isArray,
D="object"===typeof process&&k(process.nextTick)?process.nextTick:setTimeout;n.each=A(w);n.eachSeries=A(x);n.parallel=B(y);n.series=B(z);"undefined"!==typeof module&&module.exports?module.exports=n:"function"===typeof define&&define(function(){return n});"object"===typeof window&&(window.then=n);return n})();
// TEST begin
